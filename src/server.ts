...
import 'express-async-errors'; // Этот пакет автоматически перехватывает ошибки в асинхронных маршрутах Express, избавляя от необходимости использовать блоки try-catch в каждом контроллере.
